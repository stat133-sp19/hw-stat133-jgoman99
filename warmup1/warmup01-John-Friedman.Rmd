...
[1]:
https://vignette.wikia.nocookie.net/starwars/images/f/f1/TK-119.png/revision/latest?cb=20130220060544
...
[2]:
https://c2.staticflickr.com/8/7156/6482093937_3144434e26_b.jpg
...
In Cartesian coordinates, if **p** = ($p_1,p_2,...,p_n$)
and **q** = ($q_1,q_2,...,q_n$) are two points in Euclidean n-space, then the distance (d) from **p** to **q**, or from **q** to **p** is given by the Pythagorean formula:
...
$$||\textbf{p}|| = \sqrt{(p_1^2+p_2^2+...+p_n^2)} = \sqrt{p \cdot p},$$
